<%-- 
    Document   : mascotas
    Created on : 16-feb-2020, 22:36:37
    Author     : sjm00010
--%>
...
<html lang="es">
    ...
    <body>
        <div class="container espaciado">
            <div>
                <a class="btn btn-outline-success" href="registro_animal.jsp">Nueva mascota</a>
                <a class="btn btn-outline-danger" href="#">Eliminar mascota</a>
            </div>
            <div class="card mb-3 espMen" style="max-width: 100%;">
            ...
            <div class="card mb-3" style="max-width: 100%;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="../../img/pipo.jpg" class="card-img" alt="foto mascota">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h3 class="card-title">Pipo</h3>
                            <p class="card-text h4"><strong>Código de identificación :</strong> 938000777000666</p>
                            <p class="card-text h4"><strong>Edad :</strong> 4 años</p>
                            <p class="card-text h4"><strong>Raza :</strong> Perro Gambino</p>
                            <a href="#" class="espaciado btn btn-info btn-lg btn-block">+ Información</a>
